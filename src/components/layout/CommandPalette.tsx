...
export default function CommandPalette({ onClose }: CommandPaletteProps) {
  ...
  const commands: CommandItem[] = [
    ...
    { id: "nav-monitoring", label: "Go to Monitoring", category: "Navigate", action: () => navigate("/monitoring"), keywords: "monitoring activity logs sessions events" },
    { id: "nav-sessions", label: "Go to Sessions", category: "Navigate", action: () => navigate("/monitoring?tab=sessions"), keywords: "session openclaw" },
    { id: "nav-activity", label: "Go to Activity", category: "Navigate", action: () => navigate("/monitoring?tab=activity"), keywords: "activity feed events" },
    { id: "nav-logs", label: "Go to Logs", category: "Navigate", action: () => navigate("/monitoring?tab=logs"), keywords: "log viewer" },
    ...
    { id: "nav-skyward", label: "Go to Skyward", category: "Navigate", action: () => navigate("/skyward"), keywords: "skyward workstream" },
    { id: "nav-daily-brief", label: "Go to Daily Brief", category: "Navigate", action: () => navigate("/daily-news-brief"), keywords: "daily news brief standup" },
    { id: "nav-skills", label: "Go to Skills", category: "Navigate", action: () => navigate("/skills"), keywords: "skill openclaw capability" },
    { id: "nav-opp-engine", label: "Go to Opportunity Engine", category: "Navigate", action: () => navigate("/opportunity-engine"), keywords: "opportunity engine scoring qualification" },
    { id: "nav-settings", label: "Go to Settings", category: "Navigate", action: () => navigate("/settings"), keywords: "settings config" },
    { id: "nav-users", label: "Go to Users", category: "Navigate", action: () => navigate("/users"), keywords: "user manage" },
    { id: "nav-audit", label: "Go to Audit Log", category: "Navigate", action: () => navigate("/audit"), keywords: "audit log trail" },
    { id: "nav-standup", label: "Go to Standup", category: "Navigate", action: () => navigate("/standup"), keywords: "standup notes" },
    // Quick actions
